...
function Card () {
  return (
    <div className='container-fluid' style={{padding:"18px"}}>
      <div className='row' id='rw' style={{marginTop:"-203px",display:"flex",flexWrap:"nowrap",justifyContent:"center",padding:"165px"}}>
  <div class="col-sm-2">
    <div class="card h-100">
    <div class="card-body">
    <Link to={`/Signup1`}>  <svg xmlns="http://www.w3.org/2000/svg" width="33.268" height="29.109" viewBox="0 0 33.268 29.109">
